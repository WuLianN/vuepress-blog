<template>
  <div class="container">
    <div class="content">
      ...
      <div id="footer">
        <svg id="scene" x="0px" y="0px" width="1200px" height="315px">
          <path
            id="ground"
...
export default {
  ...
  mounted() {
    ...
    this.windowResizeHandler(canva);

    this.createUniverse(canva);
  },

  components: {},

  methods: {
    createUniverse(canva) {
      this.universe = canva.getContext("2d");
    ...
    windowResizeHandler(canva) {
      this.starCount = Math.floor(this.width * this.starDensity);
...
<style scoped>
@import "../styles/universeForTheme.css";
</style>